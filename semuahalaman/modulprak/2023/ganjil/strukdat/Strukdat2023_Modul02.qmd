...
2. Di macOS, setelah kompilasi, hasilnya adalah suatu *executable* atau program yang bisa dijalankan, tetapi tampaknya tidak seperti aplikasi yang biasa saya gunakan. (Sedangkan, di Windows, hasil kompilasi sudah berupa *file* `.exe` seperti aplikasi yang biasa digunakan.) Mengapa ya?
