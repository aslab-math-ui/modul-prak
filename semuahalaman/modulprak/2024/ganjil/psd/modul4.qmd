...
Selain *bar chart*, ada *pie chart* sebagai visualisasi yang berbeda untuk kegunaan yang sama. Sayangnya, di `ggplot2` tidak ada fungsi khusus untuk *pie chart*. Namun, kita bisa akali dengan membuat *bar chart* seperti berikut, yang kemudian diterapkan koordinat polar.
...
## (Pengayaan) `geom_col` untuk *bar chart* dengan ketinggian berdasarkan nilai
