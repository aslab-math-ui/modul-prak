...
| Data           | Desc               | Link               |
+================+====================+====================+
| **Our World in | Poverty, disease,  | [`https ://github. |
| Data**         | hunger, climate    | com/owid`](https : |
|                | change, war,       | //github.com/owid) |
|                | existential risks, |                    |
|                | and inequality:    |                    |
|                | the world faces    |                    |
|                | many great and     |                    |
...
|                | on.                |                    |
+----------------+--------------------+--------------------+
| [c             | The purpose of     | [`https://github   |
| ovid](         | [this noteboo      | .com/aatishb/covid |
| https://%20git | k](htt             | `](https://github. |
| hu%20b.com/%20 | ps://g%20ithub.com | com/aatishb/covid) |
| aatishb/covid) | %20/aatish%20b/cov |                    |
|                | id/blob/m%20as%20t |                    |
|                | er/curvefit.ipynb) |                    |
|                | is to infer the    |                    |
|                | rate at which      |                    |
...
|                |     country        |                    |
+----------------+--------------------+--------------------+
| Center for     | This is the data   | <https://github.c  |
| Systems        | repository for the | om/CSSEGISandData> |
| Science and    | 2019 Novel         |                    |
| Engineering    | Coronavirus Visual | <https://systems.j |
|                | Dashboard operated | hu.edu/research/pu |
|                | by the Johns       | blic-health/ncov/> |
|                | Hopkins University |                    |
|                | Center for Systems |                    |
|                | Science and        |                    |
|                | Engineering (JHU   |                    |
