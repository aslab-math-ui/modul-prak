...
2. Diberikan masalah nilai batas nonlinier
    ...
    b. Di *file* penjelasan, tentukan rumus $\frac{\partial f}{\partial y}(x,y,y')$ dan rumus $\frac{\partial f}{\partial y'}(x,y,y')$ secara analitik.

    c. Buatlah *script file* `soal_1c.m` berisi penggunaan metode *nonlinear shooting* untuk mengaproksimasi solusi dari MNB tersebut. Bandingkan dengan solusi analitik (cukup $y(t)$ saja), sertakan perhitungan *error*. Lampirkan tabel dan gambar grafiknya di *file* penjelasan, serta perhitungan nilai $N$.

    d. Buatlah *script file* `soal_1d.m` berisi penggunaan metode *nonlinear finite difference* untuk mengaproksimasi solusi dari MNB tersebut. Bandingkan dengan solusi analitik, sertakan perhitungan *error*. Lampirkan tabel dan gambar grafiknya di *file* penjelasan, serta perhitungan nilai $N$.
