...
1. Diberikan suatu masalah nilai awal (MNA) / *initial value problem* (IVP):
    ...
    b. Buatlah *script file* `soal_1b.m` berisi penggunaan satu metode ***one-step*** pilihan Anda untuk mengaproksimasi solusi dari MNA tersebut. Bandingkan dengan solusi analitik, sertakan perhitungan *error*. Lampirkan tabel dan gambar grafiknya di *file* penjelasan.
