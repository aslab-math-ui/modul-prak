...
description: "Intro to Data Analytics Libraries in Python"
date: 02/07/2024
...
:::{.callout-important}
Perhatikan perbedaan output tabel ketika menggunakan `df[[]]` dan `[]`
:::
...
```{python}
df[(df['HP'] > 50) & (df['Type 1'] == 'Fire')]  # Mengambil data pada dataframe df yang memiliki nilai kolom `HP` > 50 dan `Type 1` == Fire
```
