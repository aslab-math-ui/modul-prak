...
1. [Markdown Dasar](#markdown-dasar)  
2. [Markdown Lanjutan](#markdown-lanjutan)  
3. [Fitur Quarto Khusus Markdown](#fitur-quarto-khusus-markdown)  
4. [YAML Dasar](#yaml-dasar)  
5. [YAML Lanjutan & Quarto](#yaml-lanjutan--quarto)  
6. [Contoh Kasus: Dokumen Praktikum Interaktif](#contoh-kasus-dokumen-praktikum-interaktif)  
...
Tampilannya akan seperti ini seperti ini[^2]:
...
:::
```
    <text Hasilnya akan seperti ini. >
